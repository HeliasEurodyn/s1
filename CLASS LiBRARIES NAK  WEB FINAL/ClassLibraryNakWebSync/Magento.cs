...
namespace ClassLibraryNakWebSync
{
    class Magento
    {
        ...
        public String truncate(String url)
        {
        ...
        public String importTriger(String url)
        {
            RestClient client = new RestClient(url);
            var request = new RestRequest(Method.GET);
        ...
        public String populate(String url,PopulateItem populateItem)
        {
            RestClient client = new RestClient(url);
            ...
            request.AddParameter("application/json", "{\r\n               " +
                ...
                "\"retailPrice\"        : \"" + populateItem.specialPrice.Replace(",", ".") + "\",\r\n                                                " +
        ...
        public String updateProductPrices(String url, List<PopulateItem> items)
        {
            String ItemsInJson = "";
            bool FirstLoop = true;
            ...
            foreach (PopulateItem item in items)
            {
                ...
                ItemsInJson += " { \r\n" +
                                            ...
                                            "   \"retailPrice\" : \"" + item.specialPrice.Replace(",", ".") + "\",\r\n " +
