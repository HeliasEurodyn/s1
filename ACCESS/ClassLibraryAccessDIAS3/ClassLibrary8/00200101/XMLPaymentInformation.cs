...
{
    public class XMLPaymentInformation
    {
       ...
       // [XmlElement("Rsn")]
        ...
        public Dbtr dbtr = new Dbtr();
         ...
         [XmlElement("DbtrAcct")]
        public DbtrAcct dbtrAcct = new DbtrAcct();

       //  [XmlElement("UltmtDbtr")]
       //  public UltmtDbtr ultmtDbtr = new UltmtDbtr();

       //  [XmlElement("UltmtCdtr")]
        // public UltmtCdtr ultmtCdtr = new UltmtCdtr();
