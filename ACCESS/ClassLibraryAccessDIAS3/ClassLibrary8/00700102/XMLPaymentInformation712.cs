...
namespace Files00700102
{
    ...
    public class XMLPaymentInformation712
    {
    ...
    public class CreditorSchemeIdentificationIdentificationPrivateIdentificationOther
    {
        ...
        [XmlElement("SchmeNm")]
        public CreditorSchemeIdentificationIdentificationPrivateIdentificationOtherScemeName Sceme_Name = new CreditorSchemeIdentificationIdentificationPrivateIdentificationOtherScemeName();
